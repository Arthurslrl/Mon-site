        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
          {reviews.map((review, i) => (
            <motion.article
              ...
              whileHover={{ y: -6, boxShadow: '0 16px 40px rgba(28,10,0,0.12)' }}
              className="bg-white rounded-2xl p-6 border border-[#C41E1E]/8 hover:border-[#C41E1E]/25 transition-colors duration-200 cursor-default"
            >
              {/* Header */}
